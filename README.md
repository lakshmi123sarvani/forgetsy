...
Trends are encapsulated by a construct named Delta.(sarvani) A Delta consists of two sets of counters, each of which implements exponential time decay of the form:
